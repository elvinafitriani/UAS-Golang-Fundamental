...
function view(){
    fetch("http://localhost:5006/viewKhs")
    ...
    .then(function(json){
        ...
        for(let a in json){
            ...
            j2.textContent = json[a].nim_mhs;
            j1.appendChild(j2);

            let j3 = document.createElement("td");
            j3.textContent = json[a].nama_mahasiswa;
            j1.appendChild(j3);
            ...
            j5.textContent = json[a].semester;
            j1.appendChild(j5);

            let j6 = document.createElement("td");
            j6.textContent = json[a].thn_akademik;
            j1.appendChild(j6);

            let j7 = document.createElement("td");
            j7.textContent = json[a].grade;
            j1.appendChild(j7);
        }
